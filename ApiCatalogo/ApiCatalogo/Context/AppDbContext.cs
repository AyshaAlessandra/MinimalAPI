...
namespace ApiCatalogo.Context
{
    public class AppDbContext : DbContext
    {
        ...
        //Configura as propriedades das entidades e define o relacionamento entre elas de forma explicita
        protected override void OnModelCreating(ModelBuilder mb)
        {   
            //categoria
            mb.Entity<Categoria>().HasKey(c => c.CategoriaId); // chave primária
            ...
            mb.Entity<Produto>().Property(c => c.Preco).HasPrecision(14,02);
